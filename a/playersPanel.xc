 ...
 */
{
  ...
  "playersPanel": {
    ...
    "large": {
      ...
      "nickFormatLeft": "<font color='{{c:xeff}}' alpha='{{alive?#FF|#80}}'>{{name}}</font> <font color='{{c:xwn}}' alpha='{{alive?#FF|#80}}'>{{clan}}</font>",
      "nickFormatRight": "<font color='{{c:xeff}}' alpha='{{alive?#FF|#80}}'>{{name}}</font> <font color='{{c:xwn}}' alpha='{{alive?#FF|#80}}'>{{clan}}</font>",
