 ...
 */
{
  ...
  "playersPanel": {
    ...
    "large": {
      ...
      "nickFormatLeft": "<img src='xvm://res/icons/xvm/xvm-user-{{xvm-user}}.png'> <font color='{{c:xte}}' alpha='{{alive?#FF|#80}}'>{{xte|--}}</font> <font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>{{nick}}</font>",
      "nickFormatRight": "<font color='{{c:xwn8}}' alpha='{{alive?#FF|#80}}'>{{nick}}</font> <font color='{{c:xte}}' alpha='{{alive?#FF|#80}}'>{{xte|--}}<font> <img src='xvm://res/icons/xvm/xvm-user-{{xvm-user}}.png'>",
      ...
      "vehicleFormatLeft": "<font color='{{c:t-winrate}}'>{{vehicle}}</font> <font color='{{c:t-battles}}'>◇</font>",
      "vehicleFormatRight": "<font color='{{c:t-winrate}}'>{{vehicle}}</font> <font color='{{c:t-battles}}'>◇</font>",
      // Display format for frags (macros allowed, see macros.txt).
      // Формат отображения фрагов (допускаются макроподстановки, см. macros.txt).
      "fragsFormatLeft": "{{frags}}",
      "fragsFormatRight": "{{frags}}",
