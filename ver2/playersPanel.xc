 ...
 */
{
  ...
  "playersPanel": {
    ...
    "large": {
      ...
      "nickFormatLeft": "<font color='{{c:xeff}}' alpha='{{alive?#FF|#80}}'>{{nick}}</font> <font color='{{c:xwn}}' alpha='{{alive?#FF|#80}}'>◇</font>",
      "nickFormatRight": "<font color='{{c:xeff}}' alpha='{{alive?#FF|#80}}'>{{nick}}</font> <font color='{{c:xwn}}' alpha='{{alive?#FF|#80}}'>◇<font>",
