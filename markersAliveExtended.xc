 ...
 */
{
  ...
  "ally": {
    ...
    "clanIcon": {
      ...
      "x": -15,            // Position on the X axis / Положение по оси X.
      "y": -70,          // Position on the Y axis / Положение по оси Y.
      "w": 12,           // Width                  / Ширина.
      "h": 12,           // Height                 / Высота.
      // Opacity (dynamic transparency allowed, see macros.txt).
      // Прозрачность (допускается использование динамической прозрачности, см. macros.txt)
    ...
    "levelIcon": {
      ...
      "y": -75,          // Position on the Y axis / Положение по оси Y.
      "alpha": 100       // Opacity                / Прозрачность.
    },
    ...
    "textFields": [
	  ...
	  // XVM user?
	  {
		...
		"format": "<img src='xvm://res/icons/xvm/xvm-user-{{xvm-user}}.png'>"
	  },
      ...
      // Text field with the win-rate of the tank.
      // Текстовое поле с названием танка.
      {
        "name": "Win Rate",
        "visible": true,
        ...
        "format": "Win:{{t-winrate%2d~%|--%}}"
      },
	  // Text field with the battles of the tank.
      // Текстовое поле с названием танка.
      {
        "name": "Battles",
        "visible": true,
        ...
        "format": "Battles:{{t-kb%3.1f~k|--k}}"
      },
	  // Text field with the Efficiency of the player.
      {
        "name": "Efficiency",
        "visible": true,
        "x": -38,
	  ...
	  // Text field with the XVM WN8 rating of the player.
      {
        "name": "XVM WN8",
        "visible": true,
        "x": 38,
      ...
      // Text field with the xTE of the player.
      {
        "name": "xTE",
        "visible": true,
        "x": -38,
	  ...
	  // Text field with the average damage of the player.
      {
        "name": "Damage Ratio",
        "visible": true,
        "x": 38,
